...
#define THROTTLE_RATE_UP_PER_SEC 0.60f   // Maximum throttle increase per second (60 % by default)
#define THROTTLE_RATE_DOWN_PER_SEC 0.80f // Maximum throttle decrease per second (80 % by default)
...
#define ERROR_DEADZONE 0.1f             // Dead zone for error values
